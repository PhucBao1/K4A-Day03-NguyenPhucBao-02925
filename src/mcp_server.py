...
class MCPTravelServer:
    ...
    """
    def __init__(self, server_name: str = "personal-travel-mcp-server"):
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        # --------------------------------------------------------------------------
        # HỌC VIÊN HOÀN THIỆN HÀM GỌI TOOL CHUẨN MCP JSON-RPC
...
if __name__ == "__main__":
    print("==========================================================")
    print("🔌 KIỂM THỬ ĐỘC LẬP MCP SERVER (personal-travel-mcp-server)")
    print("==========================================================")
    ...
    booking_tool = next((t for t in tools if t.get("name") == "book_travel"), None)
    if booking_tool and not booking_tool.get("parameters", {}).get("properties"):
        print("⏳ [TODO 1.2]: Tool 'book_travel' chưa được định nghĩa properties trong 'src/tools.py'.")
    else:
        print("✅ [TODO 1.2]: Tool 'book_travel' đã có schema đầy đủ.")

    # Kiểm tra trạng thái TODO 2.1 (call_tool)
    test_result = server.call_tool("search_travel_options", {"destination": "Đà Nẵng", "date": "20/09/2026"})
    if not test_result:
        print("⏳ [TODO 2.1]: Hàm call_tool() đang trả về rỗng. Học viên hãy hoàn thiện TODO 2.1 trong 'src/mcp_server.py'!")
    else:
        print(f"✅ [TODO 2.1]: Test dispatch tool 'search_travel_options' thành công:")
